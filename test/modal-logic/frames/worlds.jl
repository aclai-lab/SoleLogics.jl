...
@test SoleLogics.goeswithdim(SoleLogics.Interval, 1)
@test !SoleLogics.goeswithdim(SoleLogics.Interval, 2)
@test Base.length(SoleLogics.Interval(12,32)) == 20
@test Base.size(SoleLogics.Interval(12,32)) == (20,)

@test_nowarn SoleLogics.Interval2D((1,2),(3,4))
@test_nowarn SoleLogics.Interval2D(SoleLogics.Interval(1,2),SoleLogics.Interval(3,4))
@test !SoleLogics.goeswithdim(SoleLogics.Interval2D, 1)
@test SoleLogics.goeswithdim(SoleLogics.Interval2D, 2)

interval2d = SoleLogics.Interval2D((1,3), (3,10))
...
@test Base.isconcretetype(Base.return_types(accessibles, typeof.((FullDimensionalFrame((5,),), [SoleLogics.Interval(2,3),SoleLogics.Interval(2,4)], SoleLogics.IA_L)))[1])
@test_broken Base.isconcretetype(eltype(Base.return_types(accessibles, typeof.((FullDimensionalFrame((5,),), [SoleLogics.Interval(2,3),SoleLogics.Interval(2,4)], SoleLogics.IA_L)))[1]))
@test_broken ((@inferred eltype(accessibles(FullDimensionalFrame((5,),), [SoleLogics.Interval(2,3),SoleLogics.Interval(2,4)], SoleLogics.IA_L))) == SoleLogics.Interval{Int})
