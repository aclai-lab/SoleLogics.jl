...
check(diamond(globalrel)(Atom('0')), KripkeWord("01001"), Point(3))
check(diamond(globalrel)(Atom('0')), KripkeWord("01001"))
check(diamond(globalrel)(Atom('0')), KripkeWord("1111"), Point(3))
check(diamond(globalrel)(Atom('0')), KripkeWord("1111"))
check(diamond(SoleLogics.PredecessorRel)(Atom('0')), KripkeWord("01001"), Point(3))
check(diamond(SoleLogics.PredecessorRel)(Atom('1')), KripkeWord("01001"), Point(3))

φ000 = globaldiamond(diamond(SoleLogics.SuccessorRel)(Atom('1') ∧ diamond(SoleLogics.SuccessorRel)(Atom('0') ∧ diamond(SoleLogics.SuccessorRel)(Atom('0')))))
...
# check(diamond(globalrel)(Atom("11") ∧ diamond(IA_A)(Atom("11") ∧ diamond(IA_A)(Atom("11")))), KripkeWord("101100011"))
