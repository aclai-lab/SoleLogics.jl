...
_accessibles(fr::Full1DFrame, w::Interval{<:Integer}, ::_IA_Ai) = zip(1:w.x-1, Iterators.repeated(w.x))
_accessibles(fr::Full1DFrame, w::Interval{<:Integer}, ::_IA_L) = _intervals_in(w.y+1, X(fr)+1)
_accessibles(fr::Full1DFrame, w::Interval{<:Integer}, ::_IA_Li) = _intervals_in(1, w.x-1)
_accessibles(fr::Full1DFrame, w::Interval{<:Integer}, ::_IA_B) = zip(Iterators.repeated(w.x), w.x+1:w.y-1)
_accessibles(fr::Full1DFrame, w::Interval{<:Integer}, ::_IA_Bi) = zip(Iterators.repeated(w.x), w.y+1:X(fr)+1)
...
_accessibles(fr::Full1DFrame, w::Interval{<:Integer}, ::_IA_DorBorE) = Iterators.flatten((_accessibles(fr, w, IA_B), _accessibles(fr, w, IA_D), _accessibles(fr, w, IA_E)))
_accessibles(fr::Full1DFrame, w::Interval{<:Integer}, ::_IA_DiorBiorEi) = Iterators.flatten((_accessibles(fr, w, IA_Bi), _accessibles(fr, w, IA_Di), _accessibles(fr, w, IA_Ei)))

_accessibles(fr::Full1DFrame, w::Interval{<:Integer}, ::_IA_I) = Iterators.flatten((
