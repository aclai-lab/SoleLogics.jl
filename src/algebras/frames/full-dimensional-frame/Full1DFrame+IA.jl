...
_accessibles(fr::Full1DFrame, w::Interval{Int}, ::_IA_AorO) = Iterators.product(w.x+1:w.y, w.y+1:X(fr)+1)
_accessibles(fr::Full1DFrame, w::Interval{Int}, ::_IA_AiorOi) = Iterators.product(1:w.x-1,   w.x:w.y-1)

_accessibles(fr::Full1DFrame, w::Interval{Int}, ::_IA_DorBorE) = Iterators.flatten((_accessibles(fr, w, IA_B), _accessibles(fr, w, IA_D), _accessibles(fr, w, IA_E)))
_accessibles(fr::Full1DFrame, w::Interval{Int}, ::_IA_DiorBiorEi) = Iterators.flatten((_accessibles(fr, w, IA_Bi), _accessibles(fr, w, IA_Di), _accessibles(fr, w, IA_Ei)))

_accessibles(fr::Full1DFrame, w::Interval{Int}, ::_IA_I) = Iterators.flatten((
