...
# ╔═╡ 4ea35bac-d47b-4258-9609-e783ee6fc09d
begin
	using PlutoUI
	using Random
	using SoleLogics
...
# ╔═╡ 12eb8901-7977-4eca-a701-e3b9430c3d36
...
# ╔═╡ b762a0a4-dff0-4cca-8324-e74f19406a1f
# Instantiate a propositional interpretation
I = TruthDict(["p" => true, "q" => false])

# ╔═╡ feaff836-9899-41b3-914b-3b84e831ea37
# Check the formula on the interpretation
check(φ, I)

# ╔═╡ addfbcaf-78f6-415e-aa09-7adb1d08d363
begin
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "d92fe1787acbddee1c2ca763ff217b70e76202d6"
...
git-tree-sha1 = "84f4020facf3f0d5d5d12624fceedd128ae9a480"
